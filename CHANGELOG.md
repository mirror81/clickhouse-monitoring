...
## [0.3.3](https://github.com/mirror81/clickhouse-monitoring/compare/v0.3.2...v0.3.3) (2026-08-13)
...
* **advisor:** extract shared query-advisor-core package ([#2968](https://github.com/mirror81/clickhouse-monitoring/issues/2968)) ([cc8ec4a](https://github.com/mirror81/clickhouse-monitoring/commit/cc8ec4aa38b5aa20e6c091544c039999ea95be53)), closes [#2936](https://github.com/mirror81/clickhouse-monitoring/issues/2936) [#2940](https://github.com/mirror81/clickhouse-monitoring/issues/2940)
* **agent-api:** split the 713-line handlePost into phase modules ([#2924](https://github.com/mirror81/clickhouse-monitoring/issues/2924)) ([bb71ded](https://github.com/mirror81/clickhouse-monitoring/commit/bb71ded57e41b75750c087f389ceb4becdf9701a)), closes [#2885](https://github.com/mirror81/clickhouse-monitoring/issues/2885)
...
* **ai:** reuse query-advisor-core helpers in sql-analysis ([#2970](https://github.com/mirror81/clickhouse-monitoring/issues/2970)) ([a60492a](https://github.com/mirror81/clickhouse-monitoring/commit/a60492ab6fa84f929402fd9a0b172df1bf1a0e0a)), closes [#2969](https://github.com/mirror81/clickhouse-monitoring/issues/2969)
* **ai:** split mv-designer into cohesive modules ([#2960](https://github.com/mirror81/clickhouse-monitoring/issues/2960)) ([6c05ed1](https://github.com/mirror81/clickhouse-monitoring/commit/6c05ed196e95d8454b0602f30e55b7f76efd93ef)), closes [#2939](https://github.com/mirror81/clickhouse-monitoring/issues/2939)
* **charts:** collapse donut formatter, split lazy chart imports and system-charts ([#2925](https://github.com/mirror81/clickhouse-monitoring/issues/2925)) ([0187695](https://github.com/mirror81/clickhouse-monitoring/commit/018769555ddc0ee7bea95d6b9a14a3b7d0a553aa))
* **charts:** split query-count-calendar into cohesive modules ([#2957](https://github.com/mirror81/clickhouse-monitoring/issues/2957)) ([3b42fa4](https://github.com/mirror81/clickhouse-monitoring/commit/3b42fa430fb437d2eeaa7cdc902e910c65935b7f)), closes [#2941](https://github.com/mirror81/clickhouse-monitoring/issues/2941)
* **clickhouse-client:** split the fetchData funnel into testable modules ([#2926](https://github.com/mirror81/clickhouse-monitoring/issues/2926)) ([9041c1a](https://github.com/mirror81/clickhouse-monitoring/commit/9041c1a2b25855928070fbe1d4649dd5e8b6a8b5)), closes [#2893](https://github.com/mirror81/clickhouse-monitoring/issues/2893)
* **cluster-topology,data-table:** split model.ts into layers + extract DataTable hooks ([#2928](https://github.com/mirror81/clickhouse-monitoring/issues/2928)) ([fc45737](https://github.com/mirror81/clickhouse-monitoring/commit/fc457373f77ecb6068da8eb43ee5c3f78ee04497)), closes [#2886](https://github.com/mirror81/clickhouse-monitoring/issues/2886) [#2889](https://github.com/mirror81/clickhouse-monitoring/issues/2889)
* **cluster-topology:** extract pure geometry from topo-canvas ([#2959](https://github.com/mirror81/clickhouse-monitoring/issues/2959)) ([9701c95](https://github.com/mirror81/clickhouse-monitoring/commit/9701c953984a3f7085c84d44bf17ddef41c5afe5)), closes [#2943](https://github.com/mirror81/clickhouse-monitoring/issues/2943)
* **connections,menu:** split ConnectionForm and menuItemsConfig ([#2929](https://github.com/mirror81/clickhouse-monitoring/issues/2929)) ([1b1ff34](https://github.com/mirror81/clickhouse-monitoring/commit/1b1ff34ab682255ef485f867adab0198af9ffdd2)), closes [#2888](https://github.com/mirror81/clickhouse-monitoring/issues/2888) [#2897](https://github.com/mirror81/clickhouse-monitoring/issues/2897)
...
* **health:** split runHealthSweep into a testable pipeline ([#2919](https://github.com/mirror81/clickhouse-monitoring/issues/2919)) ([5db5784](https://github.com/mirror81/clickhouse-monitoring/commit/5db5784ad82de64a5d129b909c054b9a3d7a0786))
* **health:** split sweep dispatch into per-channel modules ([#2964](https://github.com/mirror81/clickhouse-monitoring/issues/2964)) ([2e73ebb](https://github.com/mirror81/clickhouse-monitoring/commit/2e73ebb6077f0ee36de19e7a46997fe98c5c9215)), closes [#2938](https://github.com/mirror81/clickhouse-monitoring/issues/2938)
...
* **menu:** move Traffic under the Insights group ([#2980](https://github.com/mirror81/clickhouse-monitoring/issues/2980)) ([ecbd8ec](https://github.com/mirror81/clickhouse-monitoring/commit/ecbd8ec31e68b7531cb94b1af63e9d6ecacce20f))
* **routes:** split -charts-config into per-tab modules ([#2955](https://github.com/mirror81/clickhouse-monitoring/issues/2955)) ([06a277c](https://github.com/mirror81/clickhouse-monitoring/commit/06a277c05a98a4efcdc8a2c9a7a481e65c7e8e88)), closes [#2942](https://github.com/mirror81/clickhouse-monitoring/issues/2942)
...
* split advisor.ts and fix cross-file test mock pollution ([#2930](https://github.com/mirror81/clickhouse-monitoring/issues/2930)) ([fad191f](https://github.com/mirror81/clickhouse-monitoring/commit/fad191fdf0ca9be326a7cf3f794e0e90000705d1)), closes [#2899](https://github.com/mirror81/clickhouse-monitoring/issues/2899) [#2922](https://github.com/mirror81/clickhouse-monitoring/issues/2922)
* **sql-builder:** extract shared render engine used by builder and extension ([#2962](https://github.com/mirror81/clickhouse-monitoring/issues/2962)) ([dfc7cac](https://github.com/mirror81/clickhouse-monitoring/commit/dfc7cace9582cefd421125ff529a2d8d138304a2)), closes [#2937](https://github.com/mirror81/clickhouse-monitoring/issues/2937)
* **ui:** split tool-output, query-detail-view, and command-palette ([#2927](https://github.com/mirror81/clickhouse-monitoring/issues/2927)) ([87129b3](https://github.com/mirror81/clickhouse-monitoring/commit/87129b39016a22d56ff1fa9d0353207584ef5d79))
