...
![chmonitor cluster topology map: Keeper quorum with leader and followers, ClickHouse shard nodes, virtual cluster overlays, and an inspector panel with quorum health and znode count](/assets/screenshots/cluster-topo-viz-with-bg.png)
